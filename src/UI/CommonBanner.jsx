...
const CommonBanner = ({
    ...
    return (
        <section className={`relative w-full bg-cover bg-center mb-20 ${customStyles}`} style={{ backgroundImage: `url('/assets/about/about_banner.jpeg')` }}>
            ...
            <div className="bg-red">
                <svg
                    ...
                    <path
                        fill="#ffffff"
                        fill-opacity="1" d="M0,288L60,272C120,256,240,224,360,202.7C480,181,600,171,720,186.7C840,203,960,245,1080,234.7C1200,224,1320,160,1380,128L1440,96L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
                </svg>
            </div>
        </section>
    );
