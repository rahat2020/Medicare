import { Search, UserCheck, Calendar, CheckSquare } from 'react-feather'; 
...
export const steps = [
    ...
    },
    {
      ...
      description: "Choose your preferred doctor, select a convenient time slot, & confirm your appointment.",
    },
    {
      icon: CheckSquare,
